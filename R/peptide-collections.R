...
#'
#' @description A peptide dataset created from the multiple alignment of the reference sequence hxb2 and the seven subtypes A, B, C, D, M, CRF01, CRF02
#' 
#' @usage data(pep_hxb2)
#' @format A \code{RangedData} object. One row per peptide.
#'
#' @details
#' \itemize{
...
#'
#' @description A peptide dataset created from the multiple alignment of the reference sequence mac239 from LANL database, our mac239 and E660 subtypes.
#' 
